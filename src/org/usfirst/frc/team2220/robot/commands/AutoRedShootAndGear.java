...
public class AutoRedShootAndGear extends CommandGroup
{
	...
	public AutoRedShootAndGear()
	{
		...
		addSequential(new AutoMotion(RobotMap.inchesToEncRot(-2), RobotMap.inchesToEncRot(2), driveAccel, driveSpeed), 5);
		addSequential(new AutoMotion(RobotMap.inchesToEncRot(114.5), RobotMap.inchesToEncRot(114.5), driveAccel, driveSpeed), 5);
